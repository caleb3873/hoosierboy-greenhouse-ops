...
for name, comps in bycombo.items():
  ...
  <p class="note">12" Cassie round deco pot · {per} plants · perennial combination{(" · $%.2f" % float(comps[0]["price"])) if comps[0].get("price") else ""}</p>
  <ul>{parts}</ul>
...
<div class="page">
  ...
  <div class="chips"><span class="chip"><b>{TOT_Q:,}</b> quarts</span><span class="chip"><b>{TOT_B:,}</b> 9" lavender baskets</span><span class="chip"><b>{TOT_C:,}</b> 12" perennial combos</span><span class="chip">Ready late March to mid-April</span><span class="chip">Quarts ship 8 to a carrier</span><span class="chip"><b>$5.99</b> quarts · <b>$9.99</b> Fyre Wing heuchera · <b>$12</b> lavender baskets · <b>$24</b> 12" combos</span></div>
  ...
  <div class="how">
    ...
    <div><h4>Pricing</h4><p>Quarts $5.99. Fyre Wing heuchera $9.99. 9" lavender baskets $12.00. 12" perennial combos $24.00.</p></div>
  </div>
