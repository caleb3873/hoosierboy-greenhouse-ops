...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const html = renderEmailHtml({ sentinel, recon, link });

    const summary = { scope: sentinel.scope, plan: counts, orderGaps: recon ? recon.mismatched : null, linksReady: link ? link.tiers.HIGH.length : null };
