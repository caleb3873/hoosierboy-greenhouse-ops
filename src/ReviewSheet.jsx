...
export const dimValue = (it, dim) => { const m = it.meta || {}; if (dim === "crop") return it.crop || "—"; if (dim === "newness") return m.is_new ? "New for us" : "Grew it before"; if (dim === "form") return m.is_combo ? "single" : (/\bdouble\b/i.test(it.name || "") ? "double" : "single"); return m[dim] || "—"; };
